...
class Controler:
    ...
    @staticmethod
    def print_menu():
        pprint.pprint(["1. Add new plant", "2. Get all plants", "3. Get plant by id", "4. Delete plant by id",
                       "5. Add new employee with salon or without", "6. Get all employee", "7. Get employee by id",
                       "8. Delete employee by id", "9. Add salon by name", "10. Delete salon by id"])
