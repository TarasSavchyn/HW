...
class SchoolBus(School, Bus):
    ...
    def return_information(self):
        print(f'max_speed {self.max_speed}, mileage {self.mileage}, capacity {self.capacity}, get_school_id {self.get_school_id}, number_of_students {self.number_of_students}, bus_school_color {self.bus_school_color}')
